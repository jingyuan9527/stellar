  ...
  },
  {
    ...
    children: [
            ...
            children: [
              {
                ...
                meta: { title: '模板管理', icon: 'palette', order: 1, group: '管理' },
              },
              {
                path: '/ai/sessions',
                name: 'AiSessions',
                component: () => import('@/views/ai/sessions/index.vue'),
                meta: { title: '会话管理', icon: 'timer', order: 2, group: '管理' },
              },
              {
                path: '/ai/memory',
                name: 'AiMemory',
                component: () => import('@/views/ai/memory/index.vue'),
                meta: { title: '长期记忆', icon: 'bulb', order: 3, group: '管理' },
              },
              {
                path: '/ai/knowledge',
                name: 'AiKnowledge',
                component: () => import('@/views/ai/knowledge/index.vue'),
                meta: { title: '知识库', icon: 'book', order: 4, group: '管理' },
              },
              {
                path: '/ai/persona',
                name: 'AiPersona',
                component: () => import('@/views/ai/persona/index.vue'),
                meta: { title: '人设管理', icon: 'persona', order: 5, group: '管理' },
              },
              {
                path: '/ai/rag-eval',
                name: 'AiRagEval',
      ...
      },
      {
        ...
        meta: { title: '实用工具', icon: 'build', order: 5 },
        children: [
          {
            path: 'cover',
            name: 'ToolsCover',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: { title: '海螺管理', icon: 'conch', order: 3 },
          },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: { title: '游客访问配置', icon: 'eye', order: 3 },
          },
          {
            path: 'profile',
            name: 'SystemProfile',
            component: () => import('@/views/system/profile/index.vue'),
            meta: { title: '个人主页', icon: 'info', order: 4 },
          },
          {
            path: 'file',
            name: 'SystemFile',
